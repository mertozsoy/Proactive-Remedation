<#
.SYNOPSIS
    Intune Proactive Remediation - Remediation: Adobe Acrobat Reader DC guncelleme

.DESCRIPTION
    Guncelleme detection fazinda yapildigi icin bu script durumu loglar ve basarili doner.
    Log: C:\Temp\IntunePR-AcrobatDC-Remediation.log
#>

$LogPath = "C:\Temp\IntunePR-AcrobatDC-Remediation.log"
