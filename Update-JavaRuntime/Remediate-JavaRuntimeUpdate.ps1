<#
.SYNOPSIS
    Intune Proactive Remediation - Remediation: Oracle Java Runtime Environment guncelleme

.DESCRIPTION
    Guncelleme detection fazinda yapildigi icin bu script durumu loglar ve basarili doner.
    Log: C:\Temp\IntunePR-Java-Remediation.log
#>

$LogPath = "C:\Temp\IntunePR-Java-Remediation.log"
